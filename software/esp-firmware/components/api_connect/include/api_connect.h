...
#define MAX_URL_LEN 512 // base URL lengths should not be longer than this, not including appended query.
...
esp_err_t getServerSpeeds(LEDData ledSpeeds[], uint32_t ledSpeedsLen, esp_http_client_handle_t client, const char *URL, int retryNum);
